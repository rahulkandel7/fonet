        ...
        <div class="px-5 py-5">
            ...
            <form method="post" action="{{route('admin.memberships.store')}}" enctype="multipart/form-data">
                ...
                <div class="mt-5">
                    ...
                    <input type="text" name="post" id="post" class="border-[#5976e970] border-2 rounded-md w-full focus:ring-transparent focus:border-[#5977E9] bg-transparent mt-2" value="{{old('post')}}">
                </div>

                {{-- For address --}}
                <div class="mt-5">
                    <label for="address" class="block font-bold text-gray-600 dark:text-gray-200">Address</label>
                    <input type="text" name="address" id="address" class="border-[#5976e970] border-2 rounded-md w-full focus:ring-transparent focus:border-[#5977E9] bg-transparent mt-2" value="{{old('address')}}">
                </div>

                {{-- For Email --}}
                    <div class="mt-5">
                        <label for="email" class="block font-bold text-gray-600 dark:text-gray-200">Email Address</label>
                        <input type="email" name="email" id="email" class="border-[#5976e970] border-2 rounded-md w-full focus:ring-transparent focus:border-[#5977E9] bg-transparent mt-2" value="{{old('email')}}">
                    </div>
